...
volume_bolinha = (4/3) * math.pi * raioBolinha ** 3 
 
# Volume efetivo ocupado pelas bolinhas de queijo no pote
volume_ocupado = volume_pote * fator_empacotamento  
# Número de bolinhas de queijo que cabem no pote
num_bolinhas = volume_ocupado / volume_bolinha

print("Número de bolinhas de queijo que cabem no pote de sorvete:", int(num_bolinhas))